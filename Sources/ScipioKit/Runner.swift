...
extension Runner {
    public struct Options {
        public struct BuildOptions {
            ...
            ///
            /// - Note: This is intentionally optional to keep SwiftPMCacheKey compatibility.
...
extension Runner.Options.BuildOptions {
    ...
    fileprivate func overridden(by overridingOptions: Runner.Options.TargetBuildOptions) -> Self {
        ...
        return .init(
            ...
            keepPublicHeadersStructure: overridingOptions[keyPath: \.keepPublicHeadersStructure] ?? self[keyPath: \.keepPublicHeadersStructure],
